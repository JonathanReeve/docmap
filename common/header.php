...
<head>
    ...
    ?>
		...
		(function($){ //this wraps jQuery for noConflict mode, see http://stackoverflow.com/questions/7975093/typeerror-undefined-is-not-a-function-evaluating-document 
		 $("#myController").jFlow({
